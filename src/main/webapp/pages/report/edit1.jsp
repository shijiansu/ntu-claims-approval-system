...
<title><s:text name="report.title.report1" /></title>
</head>
<body>
 ...
 <div class="container-fluid">
  <div class="row">
   ...
   <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <%-- ---------------------------------------------------------------------------------------------------------------------------------------- --%>
    <%-- Title Section [Start] --%>
    <h3 class="page-header"><s:text name="report.title.report1" /></h3>
    <%-- Title Section [End] --%>
    <%-- ---------------------------------------------------------------------------------------------------------------------------------------- --%>
    <%-- Parameters [Start] --%>
    <div class="col-lg-6">
     ...
     <div class="well">
      ...
      <form class="bs-example form-horizontal" action="${pageContext.request.contextPath}/report_Post_Edit1.do" method="post" name="report_form" id="report_form">
       ...
       <fieldset>
        ...
        <div class="form-group">
         <div class="col-lg-8 col-lg-offset-4">
          ...
          <button type="button" class="btn btn-primary" onclick="$('#report_form').attr('action',' ${pageContext.request.contextPath}/report_Post_Edit1.do');$('#report_form').submit()"><s:text name="page.button.showreport" /></button>
     ...
     <div class="col-lg-12">
      <div class="table-responsive">
       <display:table name="report.content" id="item" class="table table-striped simple nocol" decorator="myDecorator">
        ...
        <display:column property="itemCount" title="Item Count" headerClass="r" class="r" total="true" format="{0, number,0}"></display:column>
        <display:column property="total" title="Total" headerClass="r" class="r" total="true" format="{0, number,0.00}"></display:column>
       </display:table>
      </div>
     </div>
    </c:if>
